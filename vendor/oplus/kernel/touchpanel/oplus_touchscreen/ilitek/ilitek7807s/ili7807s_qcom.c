...
int __maybe_unused ilitek7807s_spi_probe(struct spi_device *spi)
{
    ...
    ilits->shutdown_support = ts->shutdown_support;
...
static void  ilitek7807s_shutdown(struct spi_device *spi)
{
    if(ilits->shutdown_support){
